...
BE_SS <- st_read("data/Shp/sh_statbel_statistical_sectors_31370_20220101.sqlite/sh_statbel_statistical_sectors_20220101.sqlite") %>%
  st_set_crs(31370) %>%
  st_zm(drop = TRUE)

st_write(BE_SS,"data/Shp/sh_statbel_statistical_sectors_31370_20220101.sqlite/sh_statbel_statistical_sectors_20220101.gpkg" )
file.remove("data/Shp/sh_statbel_statistical_sectors_31370_20220101.sqlite/sh_statbel_statistical_sectors_20220101.sqlite")
