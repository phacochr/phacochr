...
#'   \itemize{
#'   \item `"rues"` : rues BeST prétraitées pour l'usage de `phacochr`
#'   \item `"adresses"` : adresses BeST prétraitées pour l'usage de `phacochr`
...
#'   \item `"communes"`, `"communes2024"` : communes de Belgique (version 2019--2024)
#'   \item `"communes2025"` : communes de Belgique (version 2025-...)
#'   \item `"communes2011"` : communes de Belgique (version 2011-2017)
...
#'   \item `"couronnes"` : couronnes de Bruxelles (IBSA) sur base des secteurs statistiques (version 2019-2024)
#'   \item `"couronnes2024"` : couronnes de Bruxelles (IBSA) sur base des secteurs statistiques (version 2019-2024)
#'   \item `"couronnes2025"` : couronnes de Bruxelles (IBSA) sur base des secteurs statistiques (version 2025-...)
#'   \item `"qss"` : quartiers social-santé (Vivalis) sur base des secteurs statistiques (version 2019-2024)
#'   \item `"bassins"` : bassins (Vivalis) sur base des secteurs statistiques (version 2019-2024)
#'   \item `"provinces"` : provinces de Belgique
#'   \item `"regions"` : régions de Belgique
#'   \item `"rbc"` : limites de la Région de Bruxelles-Capitale
#'   \item `"belgique"` : limites de la Belgique
#'   }
#'
...
phaco_data <- function(data,
  ...
  if(data=="qss"){warning("Vous chargez les quartiers social sante (Vivalis) construits sur base des secteurs 2019-2024 (Statbel).",call. = F)}
