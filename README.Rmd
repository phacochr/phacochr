...
| **cd_sector_x_31370** | Les coordonnée X (format: Lambert 72) du centroïde du secteur statistique où se trouve l'adresse. *`NA` si aucune coordonnée n’a été trouvée*. |
| **cd_sector_y_31370** | Les coordonnée Y (format: Lambert 72) du centroïde du secteur statistique où se trouve l'adresse. *`NA` si aucune coordonnée n’a été trouvée*. |
