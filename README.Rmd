...
|:---|:----------|:---:|-----------------------|
|        1040| [71, rue Belliard]{style="color: #0000FF"}  | :heavy_check_mark:️️ |Si la rue et le numéro sont intégrés dans le même champ, leur ordre n’a pas d’importance. La présence de signes de ponctuation (virgule, tiret…) ne pose pas de problèmes pour la détection de la rue => ils sont nettoyés avec la correction. |
...
|71, rue Belliard [BXL]{style="color: #FF0000"} 1040 |:x:️  |  
