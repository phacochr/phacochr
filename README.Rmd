...
Le principe de `phacochr` est d'adjoindre une série d'informations spatiales à la liste d'adresses originale : il s'agit bien entendu des coordonnées X-Y mais également d'informations administratives sur les entités spatiales et d'indices sur la qualité du géocodage. En voici une synthèse:
