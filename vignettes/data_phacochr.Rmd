...
* Les secteurs statistiques sont ajoutés aux données BeST à l'aide d'une jointure spatiale avec les données géospatiales. C'est notamment par le biais des secteurs statistiques que toutes les informations sont ajoutées aux adresses géocodées en fin de géocodage.
