...
::: {style="border:0px; background-color:#f7a0b9; padding: 10px; margin-bottom: 10px"}
**Page plus à jour !**

Cette page n'est plus à jour depuis la nouvelle version de `phacochr 1.0`. Elle sera réécrite dans un avenir proche.
:::
